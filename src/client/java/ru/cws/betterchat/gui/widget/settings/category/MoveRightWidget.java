...
public abstract class MoveRightWidget extends ChatWidget {
    private final CategorySettingsScreen screen;

    public MoveRightWidget(int x, int y, CategorySettingsScreen screen, int width) {
        super(x, y, width, 20, Text.of("[▶]"), Text.of("Сдвинуть категорию правее"));
        this.screen = screen;
        this.flexRender.setBaseColor(0x60101060);
        this.flexRender.setHoverColor(0x606060FF);
    }

    public static MoveRightWidget create(int x, int y, CategorySettingsScreen screen) {
...
//        return BetterChatMod.NO_HEAVY_TEXTURES ? Texted.WIDTH : Textured.WIDTH;
    ...
    public static class Texted extends MoveRightWidget {
